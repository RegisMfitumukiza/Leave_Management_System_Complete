...
import { Box, Typography, Paper, Avatar, TextField, Button, CircularProgress, Alert, Snackbar, Divider, Grid } from '@mui/material';
...
const Profile = () => {
    ...
    const CLOUD_NAME = 'daking'; // Your Cloudinary cloud name
    ...
    const handleAvatarChange = async (e) => {
        ...
        try {
            ...
            setSnackbar({
                open: true,
                message: `Failed to update avatar: ${error.message || 'Unknown error'}`,
                severity: 'error'
            });
        } finally {
